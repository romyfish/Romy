...
istream & operator>>(istream &input, indusBuilding & R)  //重载提取运算符，输入项目信息
{
	//依次输入项目的编号、名称、审批状态、建设单位、建筑地址、施工许可面积、合同金额、资金来源（项目公司：0；银行贷款：1；两者均有：2）、合同开工日期、合同完工日期
...
{
	//依次输出项目的编号、名称、审批状态、建设单位、建筑地址、施工许可面积、合同金额、资金来源（项目公司：0；银行贷款：1；两者均有：2）、合同开工日期、合同完工日期
	cout << "工业建筑" << "\t" << code << "\t" << name << "\t" << (status == true ? "已审批" : "未审批") << "\t建设单位：" << company << "\t建筑地址：" << address.city << address.district << address.street << "\n\t施工许可面积：" << area << "平方米\t合同金额：" << cost << "万元人民币\t资金来源：";
